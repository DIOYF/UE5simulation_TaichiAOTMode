...
public class CUDAProjectFF : ModuleRules
{
	...
	public CUDAProjectFF(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicAdditionalLibraries.Add(Path.Combine(project_root_path, my_cuda_lib_lib, "CUDA_Free.lib"));
